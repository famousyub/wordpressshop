// CVI wrapper source file for .NET assembly: SCProduction, Version=2.0.1.1, Culture=neutral, PublicKeyToken=null
...
// Constants
static const char * __assemblyName = "SCProduction, Version=2.0.1.1, Culture=neutral, PublicKeyToken=null";
...
int CVIFUNC SCProduction_GestionProductions_EnregistrementNumSerie(
	SCProduction_GestionProductions __instance,
	char * strNumSerie,
	...
	CDotNetHandle * __exception)
{
	...
	*strErreurRequete = 0;
	...
	// Pre-process parameter: strIndiceNumSerie
	__parameterTypeNames[1] = "System.String";
	__parameterTypes[1] = (CDOTNET_STRING);
	__parameters[1] = &strIndiceNumSerie;
	...
	// Pre-process parameter: strCodeStatutNumserie
	__parameterTypeNames[4] = "System.String";
	__parameterTypes[4] = (CDOTNET_STRING);
	__parameters[4] = &strCodeStatutNumserie;

	// Pre-process parameter: strObservation
	__parameterTypeNames[5] = "System.String";
	__parameterTypes[5] = (CDOTNET_STRING);
	__parameters[5] = &strObservation;

	// Pre-process parameter: lngId_NumSerie
	__parameterTypeNames[6] = "System.Int64&";
	__parameterTypes[6] = (CDOTNET_INT64 | CDOTNET_OUT);
	__parameters[6] = lngId_NumSerie;
	...
	__parameters[10] = strErreurRequete;
...
int CVIFUNC SCProduction_GestionProductions_EnregistrementProprieteNumSerieTR(
	SCProduction_GestionProductions __instance,
	char * strNumSerie,
	char * strCodeProduit,
	char * strIndiceProduit,
	char * strNomPropriete,
	char * strValeurPropriete,
	__int64 * lngId_Propriete_NumSerie,
	int * blnErreurSurvenue,
	int * intErreurCode,
	char ** strErreurMessage,
	char ** strErreurRequete,
	CDotNetHandle * __exception)
{
	...
	*strErreurRequete = 0;
	...
	__parameterTypeNames[3] = "System.String";
	__parameterTypes[3] = (CDOTNET_STRING);
	__parameters[3] = &strNomPropriete;

	// Pre-process parameter: strValeurPropriete
	__parameterTypeNames[4] = "System.String";
	__parameterTypes[4] = (CDOTNET_STRING);
	__parameters[4] = &strValeurPropriete;

	// Pre-process parameter: lngId_Propriete_NumSerie
	__parameterTypeNames[5] = "System.Int64&";
	__parameterTypes[5] = (CDOTNET_INT64 | CDOTNET_OUT);
	__parameters[5] = lngId_Propriete_NumSerie;
	...
	__errChk(CDotNetInvokeGenericMember(
		...
		__instance, 
		CDOTNET_CALL_METHOD, 
		"EnregistrementProprieteNumSerieTR", 
		0, 
		0, 
		10, 
		(const char **)__parameterTypeNames, 
...
int CVIFUNC SCProduction_GestionProductions_EnregistrementNonConformiteV2(
	SCProduction_GestionProductions __instance,
	char * strNumSerie,
	char * operation,
	char * Ressource,
	...
	CDotNetHandle * __exception)
{
	...
	*strMessageRetour = 0;
	...
	// Pre-process parameter: operationout
	__parameterTypeNames[7] = "System.String&";
	__parameterTypes[7] = (CDOTNET_STRING | CDOTNET_OUT);
	__parameters[7] = operationout;
...
int CVIFUNC SCProduction_GestionProductions_ifopenNC(
	SCProduction_GestionProductions __instance,
	char * SFC,
	int * bresult,
	char ** strmessage,
...
int CVIFUNC SCProduction_GestionProductions_changeResourceStatus(
	SCProduction_GestionProductions __instance,
	char * ressource,
	char * status,
	int * blnResultat,
...
int CVIFUNC SCProduction_GestionProductions_recuperationNC(
	SCProduction_GestionProductions __instance,
	char * sfc,
	char * operation,
	char * indice,
	...
	CDotNetHandle * __exception)
{
	...
	*strMessageRetour = 0;
	...
	// Pre-process parameter: libelle
	__parameterTypeNames[5] = "System.String";
	__parameterTypes[5] = (CDOTNET_STRING);
	__parameters[5] = &libelle;
...
int CVIFUNC SCProduction_GestionProductions_HoldSfc(
	SCProduction_GestionProductions __instance,
	char ** sfc,
	ssize_t __sfcLength,
	char * comment,
	...
	CDotNetHandle * __exception)
{
	...
	*sMessage = 0;
	...
	// Pre-process parameter: comment
	__parameterTypeNames[1] = "System.String";
	__parameterTypes[1] = (CDOTNET_STRING);
	__parameters[1] = &comment;
	...
	// Pre-process parameter: sMessage
	__parameterTypeNames[3] = "System.String&";
	__parameterTypes[3] = (CDOTNET_STRING | CDOTNET_OUT);
	__parameters[3] = sMessage;
...
int CVIFUNC SCProduction_GestionProductions_ReturnLastOperationWithSFC(
	SCProduction_GestionProductions __instance,
	char * SFC,
	char ** operationOut,
	int * bresult,
...
int CVIFUNC SCProduction_GestionProductions_Recuperation_status_sfc_inwork(
	SCProduction_GestionProductions __instance,
	char * SFC,
	char * operation,
	char * indiceOp,
	...
	CDotNetHandle * __exception)
{
	...
	*strMessageRetour = 0;
	...
	__errChk(CDotNetInvokeGenericMember(
		...
		__instance, 
		CDOTNET_CALL_METHOD, 
		"Recuperation_status_sfc_inwork", 
		0, 
		0, 
		6, 
		(const char **)__parameterTypeNames, 
...
int CVIFUNC SCProduction_GestionProductions_Recuperation_temps_Enattente(
	SCProduction_GestionProductions __instance,
	char * SFC,
	char * operation,
	double * elepsedQueueTime,
	int * bresult,
	char ** strmessage,
	CDotNetHandle * __exception)
{
	...
	*strmessage = 0;
	...
	// Pre-process parameter: elepsedQueueTime
	__parameterTypeNames[2] = "System.Decimal&";
	__parameterTypes[2] = (CDOTNET_DECIMAL | CDOTNET_OUT);
	__parameters[2] = elepsedQueueTime;
...
int CVIFUNC SCProduction_GestionProductions_ImpressionPKT_zpl(
	SCProduction_GestionProductions __instance,
	char * numserie,
	char * etiquetteCode,
	char * hostName,
	...
	CDotNetHandle * __exception)
{
	...
	*strMessage = 0;
	...
	// Pre-process parameter: numserie
	__parameterTypeNames[0] = "System.String";
	__parameterTypes[0] = (CDOTNET_STRING);
	__parameters[0] = &numserie;

	// Pre-process parameter: etiquetteCode
	__parameterTypeNames[1] = "System.String";
	__parameterTypes[1] = (CDOTNET_STRING);
	__parameters[1] = &etiquetteCode;

	// Pre-process parameter: hostName
	__parameterTypeNames[2] = "System.String";
	__parameterTypes[2] = (CDOTNET_STRING);
	__parameters[2] = &hostName;
